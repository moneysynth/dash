...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://moneysynth.com/calculators/loans/car-loan",
    siteName: "MoneySynth",
    locale: "en_IN",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://moneysynth.com/calculators/loans/car-loan",
  },
};
          ...
          <div className="mx-auto max-w-6xl">
            <div className="mb-8 text-center">
              ...
              <p className="mt-2 text-lg text-text-secondary">
                Calculate your Equated Monthly Installment for car loans
              </p>
            </div>
