...
export const metadata: Metadata = {
  ...
  description:
    "Free online financial calculators for loans and investments. Calculate EMI for home loans, car loans, personal loans. Calculate SIP returns, SWP, RD, FD maturity. Loan eligibility calculator, goal-based planning, credit card EMI calculator. Get accurate results with amortization schedules, growth charts, and expert insights.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Free online financial calculators for loans and investments. Calculate EMI, SIP, SWP, RD, FD, loan eligibility, and more with accurate results, amortization schedules, and growth charts.",
    type: "website",
