...
export function CarLoanCalculatorClient() {
  ...
  useEffect(() => {
    const saved = getCalculation("car-loan-emi-calculator_saved");
    if (saved) {
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter your car loan information to calculate EMI
              </CardDescription>
            </CardHeader>
          ...
          <div className="flex justify-end">
            <SaveCalculation
              calculatorType="car-loan-emi-calculator"
              calculationId="saved"
              data={{
                principal,
                rate,
